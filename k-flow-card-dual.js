...
class KFlowCard extends HTMLElement {
  ...
  _updateDynamic() {
    ...
    const remCap1 = this._val(this.config.battery_rem_cap) || 0;
    ...
    if (bh2) { bh2.setAttribute('y', fill2.y); bh2.setAttribute('height', fill2.height); }
